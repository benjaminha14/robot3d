function initializeImage() {
  ...
  //  img.src = 'images/gamut.png';
    ...
    $('#canvas_picker').click(function(event) {
        ...
        var offSetLeft = document.getElementById("cursorOffset").offsetLeft + 7.5;
        var offsetTop = document.getElementById("cursorOffset").offsetTop + 10;
        ...
        $.ajax({
            type: "POST",
            url: "https://pit-display-nukemm.c9users.io:8082",
            data: hex,
            success: success,
            dataType: datatype
        });
